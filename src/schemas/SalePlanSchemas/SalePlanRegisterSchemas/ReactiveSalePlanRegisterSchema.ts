...
export const ReactiveRegisterSalePlanRequestSchema = z.object({
  plan_register_draft_id: RequiredUUID,
  plan_id: RequiredUUID,
});

export type ReactiveRegisterSalePlanRequestType = z.infer<
  typeof ReactiveRegisterSalePlanRequestSchema
>;

export const ReactiveSalePlanRegisterResponseSchema = BaseSchema.omit({
  code: true,
  name: true,
  master_id: true,
  master_name: true,
...
export type ReactiveSalePlanRegisterResponseType = z.infer<
  typeof ReactiveSalePlanRegisterResponseSchema
>;
