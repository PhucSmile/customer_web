  ...
  return (
    <div className="container mx-auto py-12">
      ...
      <section>
        ...
        <Typography variant="paragraph" className="py-2 text-lg">
          Từ đó, chúng tôi đặt ra sứ mệnh góp phần dẫn dắt xã hội cùng sản xuất
          và tận hưởng giá trị{' '}
          <span className="text-secondary text-lg">nông sản tử tế.</span>
        </Typography>
        <Image
          src="/logosecond.png"
          alt=""
      ...
      <section>
        ...
        <ol>
          ...
          <Typography variant="paragraph">An toàn cho môi trường.</Typography>
        </ol>
        <Typography
          variant="h5"
        ...
        <Typography variant="paragraph" className="text-lg ">
          ...
          chuyên nghiệp để trao đến tận tay khách hàng những sản phẩm tốt nhất..
        </Typography>
      </section>
    </div>
  );
